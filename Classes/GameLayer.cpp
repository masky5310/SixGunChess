...
bool GameLayer::init()
{
	...
	do 
	{
		...
		//加载棋盘背景background
		chessBoard_background=CCSprite::createWithSpriteFrame(CCSpriteFrameCache::sharedSpriteFrameCache()->spriteFrameByName("Background_Grass.png"));
		chessBoard_background->setAnchorPoint(ccp(0,0));
		chessBoard_background->setPosition(ccp(0,0));
		this->addChild(chessBoard_background);

		//加载棋盘
		chessBoard=CCSprite::createWithSpriteFrame(CCSpriteFrameCache::sharedSpriteFrameCache()->spriteFrameByName("ChessBoard.png"));
		//chessBoard->setAnchorPoint(ccp(0,0));
		chessBoard->setPosition(ccp(winSize.width/2,winSize.height/2));
		this->addChild(chessBoard);

		//添加棋子 for demo
		CCSprite* chessLeaf=CCSprite::createWithSpriteFrame(CCSpriteFrameCache::sharedSpriteFrameCache()->spriteFrameByName("ChessLeaf.png"));
		chessLeaf->setPosition(ccp(winSize.width/2,winSize.height/2));
		this->addChild(chessLeaf);

		CCSprite* chessWood=CCSprite::createWithSpriteFrame(CCSpriteFrameCache::sharedSpriteFrameCache()->spriteFrameByName("ChessWood.png"));
		chessWood->setPosition(ccp(winSize.width/2,winSize.height/2-150));
		this->addChild(chessWood);
